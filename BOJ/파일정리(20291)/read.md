...
하나라도 지우게 된다면 보물은 물론이고 다시는 노트북을 쓸 수 없게 될 거야. 파일들을 잘 분석해서 보물의 주인공이 될 수 있길 바랄게. 힌트는 “확장자”야.
...
# 풀이
주어진 대로만 하면 되는 문제였다.
StringTokenizer를 이용하여 '.'의 앞뒤로 분리를 해주었다.
이후 확장자를 map에 담아서 횟수를 value로 담고, 
key들을 ArrayList에 담아서 사전순서대로 정렬시켜 주었다.
